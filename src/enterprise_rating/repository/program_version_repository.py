...
from entities import ProgramVersion  # wherever you defined your Pydantic models
...
class ProgramVersionRepository:
    ...
    @staticmethod
    def get_program_version(lob: str, progId: str, progVer: str) -> Optional[ProgramVersion]:
